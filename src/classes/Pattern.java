...
public class Pattern 
{
	...
	public boolean equals(Pattern otherPattern)
	{
		...
		{
			if(this.pattern.get(i) != otherPattern.pattern.get(i)) {  System.out.println("verschiedener inhalt beim Wort:" +this.pattern.get(i) +"  " +otherPattern.pattern.get(i)); return false; }
		}
		return true;
	}
